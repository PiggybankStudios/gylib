...
#if !defined(WINDOWS_COMPILATION) && !defined(OSX_COMPILATION) && !defined(LINUX_COMPILATION) && !defined(WASM_COMPILATION) && !defined(WASM_NEW_COMPILATION) && !defined(PLAYDATE_COMPILATION) && !defined(ORCA_COMPILATION)
#error Either WINDOWS_COMPILATION, OSX_COMPILATION, LINUX_COMPILATION, WASM_COMPILATION, WASM_NEW_COMPILATION, PLAYDATE_COMPILATION, or ORCA_COMPILATION must be defined before including anything from Common
#endif
...
#ifdef WASM_NEW_COMPILATION
#undef WASM_NEW_COMPILATION
#define WASM_NEW_COMPILATION 1
#else
#define WASM_NEW_COMPILATION 0
#endif
