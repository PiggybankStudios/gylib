...
#if !defined(WINDOWS_COMPILATION) && !defined(OSX_COMPILATION) && !defined(LINUX_COMPILATION) && !defined(WASM_COMPILATION) && !defined(PLAYDATE_COMPILATION)
#error Either WINDOWS_COMPILATION, OSX_COMPILATION, LINUX_COMPILATION, WASM_COMPILATION, or PLAYDATE_COMPILATION must be defined before including anything from Common
#endif
